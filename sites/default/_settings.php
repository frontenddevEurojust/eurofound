...
$conf['site_mail'] = "$dev_username+drupal@eworx.sa";
$conf['smtp_from'] = 'ef+drupal+sender@eworx.sa';
$conf['smtp_fromname'] = 'drupal test mail sender';
$conf['smtp_host'] = 'elrond.eworx.sa';

$conf['update_notify_emails'] = array("$dev_username@eworx.sa");
...
//	$conf['cron_safe_threshold'] = 0; // we use elysia_cron triggered via crontab