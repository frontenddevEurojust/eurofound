(function ($)
{
	...
	$(document).ready(function()
	{
		...
		d3.csv('/sites/default/files/ejm/data/' + languageCode + '/balance-care/balance-care_' + languageCode + '.csv', function(csv)
		{
			if (csv === null)
			{
				console.log('Requested csv at "/sites/default/files/ejm/data/' + languageCode + '/balance-care/balance-care_' + languageCode + '.csv" was not found.');
			}
