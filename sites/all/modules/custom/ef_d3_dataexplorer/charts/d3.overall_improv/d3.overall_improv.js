(function ($) {
  ...
  var alphaSort = [overallFunctions.translatedValue(dataFile, 'overall-improv_sortOptionDefault'), overallFunctions.translatedValue(dataFile, 'overall-improv_sortOption1'), overallFunctions.translatedValue(dataFile, 'overall-improv_sortOption2')];
  ...
  overallFunctions.translateData = function(dataFile, csv)
  {
    var data = csv.map(function(row)
    {
      ...
      row.modalityValue = overallFunctions.translatedValue(dataFile, 'overall-improv_filter_group' + row.modalityCode);
      return row;
    });
    return data;
  }
  ...
  var customLimits = overallFunctions.customSettings(settingsData, 'overall-improv', modalityCode);
  ...
  d3.queue()
    ...
    .defer(d3.csv, '/sites/default/files/ejm/data/en/overall-improv/overall-improv_en.csv')
    .await(function(error, settingsFile, dataFile, csv)
  {
      if (csv === null){
        console.log('Requested csv at "/sites/default/files/ejm/data/en/overall-improv/overall-improv_en.csv" was not found.');
      }
    ...
    settingsData = function(settingsFile)
    {
      ...
      var legendLabels = [
    {label: overallFunctions.translatedValue(dataFile, 'overall-improv_legend1'), class: "lollipop-start"}, 
    {label: overallFunctions.translatedValue(dataFile, 'overall-improv_legend2'), class: "lollipop-end"},
      ];
