(function ($) {
  ...
  function updateGraph() {
    console.log('entro al updateGraph');
    ...
    var domainMin = Math.round(calculateMinValue(data) - 1);
    ...
    $('.y-axis .tick.highlighted').removeClass('highlighted');

    // Add new higlighted
    $('.y-axis .tick.' + countryCode).addClass('highlighted');
