(function ($) {
    ...
    .await(function(error, settingsFile, dataFile, csv)
  {
    ...
    settingsData = function(settingsFile)
    {
      ...
      var legendLabels = [
    {label: overallFunctions.translatedValue(dataFile, 'liv-depr-optim_legend1'), class: "lollipop-start"}, 
    {label: overallFunctions.translatedValue(dataFile, 'liv-depr-optim_legend2'), class: "lollipop-end"},
      ];
