...
abstract class ViewsRowPlugin_EfEntityBase extends \views_plugin_row {
  ...
  public function pre_render($rows) {
    ...
    // Build the entities.
    $entityDisplay = $this->getEntityDisplay();
    $builds = $entityDisplay->buildEntities($this->entityType, $entities);
   ...
   */
  abstract protected function getEntityDisplay();
