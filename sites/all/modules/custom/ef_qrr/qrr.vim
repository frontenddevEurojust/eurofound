...
silent only
cd /var/www/vhosts/eurofound_drupal/development/trunk/ef/sites/all/modules/custom/ef_qrr
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 ef_qrr.admin.inc
badd +0 ef_qrr.module
argglobal
silent! argdel *
argadd ef_qrr.admin.inc
set stal=2
edit ef_qrr.admin.inc
...
silent! normal! zE
let s:l = 535 - ((20 * winheight(0) + 21) / 42)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
535
normal! 04|
tabedit ef_qrr.module
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 357 - ((41 * winheight(0) + 21) / 42)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
357
