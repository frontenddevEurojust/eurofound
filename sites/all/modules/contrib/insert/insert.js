...
Drupal.behaviors.insert.attach = function(context) {
  ...
  function insert() {
    ...
    // BILBOMATICA Check if the button is inside a table. In that case we need to find wrapper in the row and style settings in it's cell (Issue: 3204 Comment: 13012)
    ...
    for (var fieldName in settings.fields) {
      ...
      if (fieldValue) {
        ...
        // BILBOMATICA Check if there is selected text in the editor. In that case include the link with this text (Issue: 3204 Comment: c12896)
