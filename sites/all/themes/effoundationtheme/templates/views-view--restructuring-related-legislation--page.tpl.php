...
if(split('[/]', $_SERVER['REQUEST_URI'])[1] == 'print' || split('[/]', $_SERVER['REQUEST_URI'])[1] == 'printpdf'){
 ...
 for ($i = 0; $i < sizeof($content_total_array); $i++) {
   ...
   if($nodo){
     ...
     print'<h1 class="title-general-comparison"><span class="restructuring-view-title">Restructuring related legislation</span> ' . $titulo . '</h1>';
...
<?php if(!strrpos($_SERVER['REQUEST_URI'], "print")): ?>
    ...
    (function ($) {
      $(document).ready(function() {
          ...
          /* Restructuring related legislation . Hide view-grouping */
          $('.page-restructuring-related-legislation h1#page-title').remove();
