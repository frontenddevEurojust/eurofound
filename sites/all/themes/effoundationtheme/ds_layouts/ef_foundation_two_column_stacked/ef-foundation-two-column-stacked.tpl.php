...
<<?php print $layout_wrapper; print $layout_attributes; ?> class="<?php print $classes;?> clearfix">
  ...
  <div class="row">
    <?php if (!empty($node_side_info)): ?>
      <<?php print $node_side_info_wrapper; ?> class="ds-node-side-info<?php print $node_side_info_classes; ?> large-4 columns">
        <?php print $node_side_info; ?>
      </<?php print $node_side_info_wrapper; ?>>
    <?php endif; ?>

    <?php $content_columns = empty($node_side_info) ? 'large-12' : 'large-8' ?>
