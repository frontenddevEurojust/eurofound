...
* EFDR-837 kp eworx 
* ---------------------------------
* drush -r /var/www/ef scr sites/all/_docs/php-scripts/migration_data_processings/fix_remaining_problematic_file_references.php
*
* the
*/
		    ...
		    if(preg_match_all("/$regexp/siU", $html, $matches, PREG_SET_ORDER)) {
		    	 ...
		    	 foreach($matches as $match) {
					...
					if($validLink){				
						...
						$fixedLink = $link;
						$fixedLink = str_replace("WEB_PATH", "/ef/sites/default/files/ef_files", $fixedLink);
						echo "   - " . $link . " = ". $fixedLink ."\n";
