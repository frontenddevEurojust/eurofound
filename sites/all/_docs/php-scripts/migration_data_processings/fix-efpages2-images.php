...
* ---------------------------------
*
* time drush -r /var/www/ef scr sites/all/_docs/php-scripts/fix-efpages-images.php
...
*/
	...
	$result = db_query("select page_id, link, replace_with from efpages_images2 group by page_id, link order by page_id");
	$count = 0;
